...
const ROLE_GUIDANCE: Record<string, string> = {
  ...
  emotionAnalyst: `You are the emotion analyst. Identify the affective states present in the evidence (for example: grief, longing, anger, release, tenderness, resignation). Distinguish emotion from sentiment: emotion names a felt state, sentiment describes polarity and intensity.`,
...
export function buildSpecialistPrompt(
  ...
  const includeLyrics = options.includeLyrics && role === 'lyricsSpecialist';
